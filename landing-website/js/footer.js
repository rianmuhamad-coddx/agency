    ...
    <footer class="bg-slate-900 text-slate-300">
      <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div class="lg:col-span-2">
            <a href="index.html" class="flex items-center gap-2 mb-4">
              ...
              <span class="text-xl font-bold text-white">FlowTask</span>
            </a>
            <p class="text-sm text-slate-400 max-w-xs mb-6">Platform manajemen proyek yang membantu tim bekerja lebih produktif dan terorganisir.</p>
            <div class="flex gap-4">
              ...
              <a href="#" class="text-slate-400 hover:text-white transition-colors" aria-label="GitHub">
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li><a href="features.html" class="text-sm hover:text-white transition-colors">Features</a></li>
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li><a href="about.html" class="text-sm hover:text-white transition-colors">About</a></li>
              <li><a href="blog.html" class="text-sm hover:text-white transition-colors">Blog</a></li>
              <li><a href="careers.html" class="text-sm hover:text-white transition-colors">Careers</a></li>
        ...
        <div class="mt-12 border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p class="text-sm text-slate-400">© 2026 FlowTask. All rights reserved.</p>
          <p class="text-sm text-slate-500">Built with HTML + Tailwind CSS</p>
        </div>
      </div>
    </footer>
  `;
